                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="role" id="roleSelect" class="form-select" required onchange="toggleSpecialty()">
                        ...
                        <div class="mb-3" id="specialtyGroup">
                            ...
                            <input type="text" name="specialty" class="form-control" placeholder="e.g. General Physician">
                        </div>
             ...
             <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        <?php
                        try {
                            $stmt = $pdo->query("SELECT name, email, specialty FROM users WHERE role = 'doctor'");
                            while ($row = $stmt->fetch()) {
                                $spec = $row['specialty'] ? " - " . htmlspecialchars($row['specialty']) : "";
                                echo "<li class='list-group-item'>" . htmlspecialchars($row['name']) . " (" . htmlspecialchars($row['email']) . ")$spec</li>";
                            }
                        } catch (PDOException $e) {
...
function toggleSpecialty() {
    ...
    const group = document.getElementById('specialtyGroup');
    if (role === 'doctor') {
