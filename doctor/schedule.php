...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add_schedule') {
    ...
    try {
        ...
        error_log("Error adding schedule: " . $e->getMessage()); $error = "An unexpected error occurred.";
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'generate_slots') {
    ...
    try {
        ...
        error_log("Error generating slots: " . $e->getMessage()); $error = "An unexpected error occurred.";
    }
}
