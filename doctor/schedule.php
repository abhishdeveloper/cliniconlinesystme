...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add_schedule') {
    ...
    try {
        ...
        $error = "An unexpected error occurred while adding the schedule.";
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'generate_slots') {
    ...
    try {
        ...
        error_log("Slot Generation Error: " . $e->getMessage());
        $error = "An unexpected error occurred while generating slots.";
    }
}
