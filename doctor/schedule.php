...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'generate_slots') {
    ...
    try {
        ...
        // Bolt Optimization: Prevent N+1 queries by fetching existing slots into a hash map
        ...
        $today_start->setTime(0, 0, 0); // Start of day to match the generation range
        $existing_slots_stmt->execute([$_SESSION['user_id'], $today_start->format('Y-m-d H:i:s')]);
