...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_status') {
    ...
    try {
        ...
        setFlashMessage('danger', "An unexpected error occurred while updating the appointment.", 'danger');
    }
}
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        echo "<tr><td colspan='5' class='text-danger'>An unexpected error occurred while loading appointments.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
