...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_status') {
    ...
    try {
        ...
        error_log("Error updating appointment: " . $e->getMessage()); setFlashMessage('danger', "An unexpected error occurred.", 'danger');
    }
}
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        error_log("Error loading appointments: " . $e->getMessage()); echo "<tr><td colspan='5' class='text-danger'>An unexpected error occurred.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
