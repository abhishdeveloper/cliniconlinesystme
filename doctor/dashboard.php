...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_status') {
    ...
    try {
        ...
        setFlashMessage('danger', "A database error occurred while updating the appointment. Please try again later.", 'danger');
    }
}
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        error_log("Database error: " . $e->getMessage());
                        echo "<tr><td colspan='5' class='text-danger'>A database error occurred while loading appointments.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
