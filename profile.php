                    ...
                    <form method="POST" action="">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary toggle-password" type="button" aria-label="Show current password">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-outline-secondary toggle-password" type="button" aria-label="Show new password">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-outline-secondary toggle-password" type="button" aria-label="Show confirm new password">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                </div>
                            </div>
