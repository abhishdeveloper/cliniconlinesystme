                            ...
                            <tbody>
                                ...
                                if (count($appointments) > 0) {
                                    foreach ($appointments as $appt) {
                                        ...
                                        echo "<td><small>" . htmlspecialchars($appt['notes']) . "</small>";
                                        ...
                                        if ($appt['status'] === 'confirmed') {
                                             echo "<br><a href='../video_call.php?appointment_id=" . $appt['id'] . "' class='btn btn-sm btn-info text-white mt-1' target='_blank'><i class='fas fa-video'></i> Join Video Call</a>";
                                        }
