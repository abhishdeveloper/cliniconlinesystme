                            ...
                            <tbody>
                                ...
                                if (count($appointments) > 0) {
                                    foreach ($appointments as $appt) {
                                        ...
                                        echo "<td>";
                                        echo "<a href='../chat.php?user_id=" . $appt['doctor_id'] . "' class='btn btn-sm btn-info text-white me-1'><i class='fas fa-comments'></i> Chat</a>";

                                        // Show prescription link if available
                                        if ($appt['prescription_id']) {
                                            echo "<a href='../prescription_view.php?id=" . $appt['prescription_id'] . "' class='btn btn-sm btn-outline-primary' target='_blank'><i class='fas fa-file-prescription'></i> Rx</a>";
                                        }
                                        echo "</td>";
