    ...
    <div class="card shadow p-5" id="prescriptionContent">
        ...
        <div class="rx-details row mb-4">
            ...
            <div class="col-md-6">
                ...
                <?php if ($rx['vikruti']): ?><strong>Vikruti:</strong> <?php echo htmlspecialchars($rx['vikruti']); ?><br><?php endif; ?>
                <?php if ($rx['pulse']): ?><strong>Pulse:</strong> <?php echo htmlspecialchars($rx['pulse']); ?><br><?php endif; ?>
                <?php if ($rx['tongue']): ?><strong>Tongue:</strong> <?php echo htmlspecialchars($rx['tongue']); ?><br><?php endif; ?>
                <?php if ($rx['skin']): ?><strong>Skin:</strong> <?php echo htmlspecialchars($rx['skin']); ?><br><?php endif; ?>
            </div>
        </div>
